...
if(isset($_POST['Register'])){
    ...
    if($saved) header("Location: AddPetugas.php");
                ...
                <div class="card-body">
                  ...
                  <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input name="Alamat" type="text" class="form-control" placeholder="Alamat" id="Password" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input name="Level" type="text" class="form-control" placeholder="Level" id="Level">
                    </div>
